...
onMounted(() => {
  buttonElement.value = document.querySelector('#button');
  modalElement.value = document.querySelector('#modal');
  closeButton.value = document.querySelector('#closeButton');

  if (modalElement.value) {
    const modal = new Modal(modalElement.value, modalOptions);
    buttonElement.value?.addEventListener('click', () => modal.toggle());
    closeButton.value?.addEventListener('click', () => modal.hide());
